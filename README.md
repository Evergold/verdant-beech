...
- `gemini/imagen-4.0-ultra-generate-001` [Tier 2] (Capabilities: *One-Shot, Photorealism*) **[DEPRECATED: 2026-08-17]**
- `gemini/nano-banana-pro` [Tier 2] (Capabilities: *Iterative, Consistency, Photorealism*)
- `gemini/gemini-2.5-flash-image` [Tier 1] (Capabilities: *Iterative, Rapid*)
- `gemini/imagen-4.0-generate-001` [Tier 1] (Capabilities: *One-Shot, Photorealism*) **[DEPRECATED: 2026-08-17]**
- `gemini/nano-banana-2` [Tier 1] (Capabilities: *Iterative, Rapid, Photorealism*)
- `gemini/gemini-3.1-flash-lite-image` [Tier 0] (Capabilities: *One-Shot, Rapid*)
- `gpt-image-2` [Tier 1] (Capabilities: *General*)
- `huggingface/black-forest-labs/FLUX.2` [Tier 1] (Capabilities: *Optics*)
- `bedrock/amazon.titan-image-generator-v1` [Tier 0] (Capabilities: *Enterprise*)
